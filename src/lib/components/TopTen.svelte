<script lang="ts">
	const topTen = [
		...
		{
			title: "ev ревюта",
			description: 'Volvo C40 Recharge - "Първият" електромобил на Volvo'
		},
		{
			title: "ev ревюта",
			description: 'Nissan Ariya - "Nissan - Megane " скъпият японски SUV'
		},
		{
			title: "ev ревюта",
		...
		{
			title: "ev ревюта",
			description: "Megane E-Tech - Удобен за града и около него"
		}
	];
</script>
